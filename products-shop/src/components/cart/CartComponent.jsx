...
const CartComponent = () => {
    ...
    const {  cartCounter, isNotification } = useContext(CartContext);
    ...
    return (
        ...
        <div className={styles.cart} >
            ...
            <div className={` ${!isNotification  ? styles.movingDiv : styles.hidden }`} role="alert">
              {isEnglish ? 'This item has been added to the cart!' : 'Продуктът е добавен в количката!'}
            </div>

            <div className={styles.cartContainer} onClick={toggleCartProducts}>
